...
function Header(){
    ...
    return(
        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto lg:mx-12 max-w-full xl:mx-12 xl:pt-32 xl:pb-40 lg:pt-40   lg:pb-40 pt-24">
            <div>
              
              <div>
                <h1 className="text-4xl font-bold tracking-tight  pb-8 sm:text-center sm:text-7xl">
                   About Us
